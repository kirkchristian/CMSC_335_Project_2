...
public class Rectangle extends TwoDimensionalShape {
    ...
    //assume rectangle is valid and width and height are positive
    ...
    //encapsulate width and height fields
    ...
    public ImageIcon createImageIcon() {
        try {
            Image image = ImageIO.read(new File("shapes/rectangle.png"));
    ...
    public String toString() {
        return "Rectangle [Width: " + getWidth() + ", Height: " + getHeight() + ", " + super.toString() + "]";
    }
}
